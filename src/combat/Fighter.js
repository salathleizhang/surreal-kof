...
import { localBoxToWorld } from './collision/geometry.js';
import {
  playHit, playHurtVoice, playDeathVoice,
} from '../audio.js';
import { CHARACTER_SCALE, FIGHTER_STATE, STATUS } from '../config/combat.js';
...
export default class Fighter {
  ...
  playState(state, combatState = FIGHTER_STATE.ATTACKING) {
