...
interface CreateCharacterModalOptions {
  onComplete?: (manifest: GeneratedCharacterManifest) => void | Promise<void>;
  onClose?: () => void;
  mock?: boolean;
}

export function openCreateCharacterModal({
  onComplete, onClose, mock = false,
}: CreateCharacterModalOptions = {}) {
  injectStyle();
...
import type { GeneratedCharacterManifest } from '../types/generatedCharacter.ts';
